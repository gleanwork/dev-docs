...
<Steps>
  ...
  <Step title="Edit Theme Code">
    ...
    <Frame>
      <img src="./images/zendesk/guide/edit-code.png" alt="Edit Code" />
    </Frame>
...
<Steps>
  <Step title="Import JavaScript Files">
    ...
    <Frame>
      <img src="./images/zendesk/guide/add-glean-sdk.png" alt="Add Glean SDK" />
    </Frame>
  </Step>
  ...
  <Step title="Replace Search UI Components">
    ...
    <Frame>
      <img src="./images/zendesk/guide/search-box-hero.png" alt="Search Box Hero" />
    </Frame>
    ...
    <Frame>
      <img src="./images/zendesk/guide/search-results.png" alt="Search Results" />
    </Frame>
  </Step>
  ...
  <Step title="Add Compact Search Box">
    ...
    <Frame>
      <img src="./images/zendesk/guide/search-box-compact.png" alt="Search Box Compact" />
    </Frame>
  </Step>
