...
This guide explains how to use User Tokens for authentication with Glean's API. User Tokens can authenticate requests on behalf of a specific user in your organization. The guide provides step-by-step instructions for configuring proper token permissions and making authenticated API requests.
