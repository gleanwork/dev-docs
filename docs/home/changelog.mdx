...
- A new [SDK](/docs/home/get-started/sdk) page with documentation for all available SDKs.
- A list of [community projects and resources](/docs/home/get-started/community) to help you get started with Glean.
...
<Update label="Mar 11, 2025" tags={["SDK"]}>
    ...
    Visit the [SDK page](/docs/home/get-started/sdk) for more information.
</Update>
