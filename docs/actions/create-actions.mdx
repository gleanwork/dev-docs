...
<Frame>
  <img src="./images/create-new-action.png" alt="Create new action interface" />
</Frame>
  ...
  <Step title="Functionality">
    ...
    <Tabs>
      <Tab title="Template-Based">
        ...
        <Frame>
          <img src="./images/actions-functionality-template.png" alt="Template-based functionality" />
        </Frame>
      </Tab>
