...
<CardGroup cols={1}>
  <Card
    title="Glean Chat"
    icon="comments"
    href="/docs/web/components/chat">
    Embed a fully functional Chat component on your site with minimal code integration.

    <Frame>
      <img src="./images/introduction/chat-example-1.png" alt="Glean Chat Interface" />
    </Frame>
  </Card>
  ...
  <Card
    ...
    href="/docs/web/components/autocomplete">
    ...
    <Frame>
      <div className="grid grid-cols-2 gap-3">
        <img src="./images/introduction/autocomplete-1.png" alt="Autocomplete Interface" />
        <img src="./images/introduction/search-results.png" alt="Search Results Interface" />
      </div>
    </Frame>
  </Card>
  ...
  <Card
    ...
    href="/docs/web/components/modal-search">
    Display search in a modal dialog overlay with single-line code implementation.

    <Frame>
      <img src="./images/introduction/nsr-1.png" alt="Modal Search Interface - Example 1" />
    </Frame>
    <Frame>
      <img src="./images/introduction/nsr-2.png" alt="Modal Search Interface - Example 2" />
    </Frame>
  </Card>
  ...
  <Card
    ...
    icon="sidebar"
    href="/docs/web/components/sidebar">
    Access Glean search, chat, and contextual recommendations for the current page through a convenient sidebar interface.

    <Frame>
      <div className="grid grid-cols-2 gap-3">
        <img src="./images/introduction/sidebar-1.png" alt="Sidebar Interface - Example 1" />
        <img src="./images/introduction/sidebar-2.png" alt="Sidebar Interface - Example 2" />
      </div>
    </Frame>
  </Card>
  ...
  <Card
    ...
    icon="lightbulb"
    href="/docs/web/components/recommendations">
    Embed contextual recommendations, search, and chat capabilities directly within your page layout.

    <Frame>
      <div className="grid grid-cols-2 gap-3">
        <img src="./images/introduction/recommendations-1a.png" alt="Recommendations Interface - Example 1" className="bg-gray-100" />
        <img src="./images/introduction/recommendations-1b.png" alt="Recommendations Interface - Example 2" className="bg-gray-100" />
      </div>
    </Frame>
  </Card>
</CardGroup>