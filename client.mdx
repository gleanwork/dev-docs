...
<Note>
For the sake of the example, we shall demonstrate the usage of the [/createcollection](/api-reference/collections/create-collection) developer-ready endpoint.
