...
<Frame>
<img src="./images/chat_interface.png"/>
</Frame>
...
- A Glean deployment
- A [Glean API key](/docs/home/tokens)
...
2. Create a python file called `chatbot.py` to instantiate the LLM and embedding model:
   ...
   <Note> You can update this code to use different foundational LLMs, or add the `base_url` parameter if you are using privately hosted NVIDIA NIM microservices.</Note>
