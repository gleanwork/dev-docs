...
<Info>
Admins can manage these API tokens via the [**API tokens page within the admin console**](https://app.glean.com/admin/platform/tokenManagement) (Admin console > Platform > API tokens > Indexing tokens tab).
</Info>
...
![add-new-token](./images/add-indexing-api-token.png "#width=calc(60% - 10px);vertical-align=top;")
...
![greenlisted-ips](./images/greenlisted-ips.png "#width=calc(60% - 10px);vertical-align=top;")
...
![rotation-period](./images/rotation-period.png "#width=calc(60% - 10px);vertical-align=top;")
...
![create-token-success](./images/create-token-success.png "#width=calc(60% - 10px);vertical-align=top;")
