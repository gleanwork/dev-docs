...
<AccordionGroup>
  <Accordion title="Option 1: Using the Glean custom app setup page" defaultOpen={true}>
...
<Accordion title="Option 2: Using the /adddatasource endpoint">
...
| `datasourceCategory` | The type of this datasource. This affects how results are ranked. More details on how to select a category can be inferred from [Datasource category](../indexing_api_datasource_category) documentation. |
...
request = IndexDocumentRequest(
    ...
    document=DocumentDefinition(
        ...
        body=ContentDefinition(
          ...
          text_content="This doc will help you get familiar with Blue Sky API"
        ),
